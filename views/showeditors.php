                    ...
                    <ul class="editor__list">
                        <?php foreach ($datas['books'] as $book): ?>
                            <li class="editor__item">
                                <a class="editor__link" href="?a=show&e=books&id=<?php echo $book->id; ?>&with=authors,editors"><?php echo $book-> title; ?></a>
                            </li>
                        <?php endforeach; ?>    
                    </ul>
                </div>
                <div class="editor__author">
                    <h3 class="editor__title" >Auhtors edited by <?php echo $datas[ 'editors' ] -> name; ?></h3>
                    <ul class="editor__list">
